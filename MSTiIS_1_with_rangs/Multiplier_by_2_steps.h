/* Лабораторная работа 1 по дисциплине МРЗвИС
	...
	Файл является заголовочным файлом класса Multiplier_by_2_steps
...
class Multiplier_by_2_steps : public Multiplier {
protected:

	void sum_of_temp_stages_result(vector<int>, vector<int>, vector<int>, vector<int>, vector<int>, vector<int>, vector<int>, vector<int>);
	virtual void multiply() override;

public:

	Multiplier_by_2_steps() :Multiplier() { }
